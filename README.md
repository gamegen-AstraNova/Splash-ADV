...
- Splash 的部分關卡選單仍混入中文。
- 2026-09-16 已將 38 張正式 PNG 原尺寸轉為保留 alpha 的高品質 WebP，並將 30 段 4096×2304 H.264 動畫縮至 1920×1080、保留 16 FPS、時長與全部 1,950 幀；本機 HTTP 子路徑載入無 console 警告或錯誤，重建 ZIP 由 323.64 MB 降至 123.79 MB。
